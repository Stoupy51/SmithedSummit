...
#> python_datapack_summit:custom_blocks/deepslate_steel_ore/place_main
#
...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function python_datapack_summit:custom_blocks/deepslate_steel_ore/place_secondary
...
scoreboard players add #total_deepslate_steel_ore python_datapack_summit.data 1
