...
#> python_datapack_summit:custom_blocks/steel_ore/replace_item
#
# @within	python_datapack_summit:custom_blocks/steel_ore/destroy
#

# If silk touch applied
execute if score #is_silk_touch python_datapack_summit.data matches 1 run data modify entity @s Item.id set from storage python_datapack_summit:items all.steel_ore.id
execute if score #is_silk_touch python_datapack_summit.data matches 1 run data modify entity @s Item.components set from storage python_datapack_summit:items all.steel_ore.components
