...
#
# @within	python_datapack_summit:v1.0.0/load/confirm_load 10s
#			python_datapack_summit:v1.0.0/load/secondary
#
...
execute if score #zone_loaded python_datapack_summit.data matches 0 run schedule function python_datapack_summit:v1.0.0/load/confirm_load 10s
